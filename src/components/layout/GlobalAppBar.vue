...
const navItems = computed(() => {
  const items = [
    ...
    { key: 'welding-schedule', label: '용접일정', to: { name: 'welding-schedule' } },
    { key: 'shipment-schedule', label: '출하일정', to: { name: 'shipment-schedule' } },
    { key: 'shipment-spec', label: '출하명세서', to: { name: 'shipment-spec' } },
...
const activeSection = computed(() => {
  ...
  if (route.path.startsWith('/shipment-spec')) return 'shipment-spec'
